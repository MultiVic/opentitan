...
package dma_reg_pkg;
  ...
  parameter logic [BlockAw-1:0] DMA_STATUS_OFFSET = 9'h 48;
  parameter logic [BlockAw-1:0] DMA_ERROR_CODE_OFFSET = 9'h 4c;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_0_OFFSET = 9'h 50;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_1_OFFSET = 9'h 54;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_2_OFFSET = 9'h 58;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_3_OFFSET = 9'h 5c;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_4_OFFSET = 9'h 60;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_5_OFFSET = 9'h 64;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_6_OFFSET = 9'h 68;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_7_OFFSET = 9'h 6c;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_8_OFFSET = 9'h 70;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_9_OFFSET = 9'h 74;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_10_OFFSET = 9'h 78;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_11_OFFSET = 9'h 7c;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_12_OFFSET = 9'h 80;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_13_OFFSET = 9'h 84;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_14_OFFSET = 9'h 88;
  parameter logic [BlockAw-1:0] DMA_SHA2_DIGEST_15_OFFSET = 9'h 8c;
  parameter logic [BlockAw-1:0] DMA_HANDSHAKE_INTR_ENABLE_OFFSET = 9'h 90;
  parameter logic [BlockAw-1:0] DMA_CLEAR_INTR_SRC_OFFSET = 9'h 94;
  parameter logic [BlockAw-1:0] DMA_CLEAR_INTR_BUS_OFFSET = 9'h 98;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_0_OFFSET = 9'h 9c;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_1_OFFSET = 9'h a0;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_2_OFFSET = 9'h a4;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_3_OFFSET = 9'h a8;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_4_OFFSET = 9'h ac;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_5_OFFSET = 9'h b0;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_6_OFFSET = 9'h b4;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_7_OFFSET = 9'h b8;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_8_OFFSET = 9'h bc;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_9_OFFSET = 9'h c0;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_ADDR_10_OFFSET = 9'h c4;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_0_OFFSET = 9'h 11c;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_1_OFFSET = 9'h 120;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_2_OFFSET = 9'h 124;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_3_OFFSET = 9'h 128;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_4_OFFSET = 9'h 12c;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_5_OFFSET = 9'h 130;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_6_OFFSET = 9'h 134;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_7_OFFSET = 9'h 138;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_8_OFFSET = 9'h 13c;
  parameter logic [BlockAw-1:0] DMA_INTR_SRC_WR_VAL_9_OFFSET = 9'h 140;
  ...
  parameter logic [3:0] DMA_PERMIT [61] = '{
    ...
    4'b 1111, // index[23] DMA_SHA2_DIGEST_3
    4'b 1111, // index[24] DMA_SHA2_DIGEST_4
    4'b 1111, // index[25] DMA_SHA2_DIGEST_5
    4'b 1111, // index[26] DMA_SHA2_DIGEST_6
    4'b 1111, // index[27] DMA_SHA2_DIGEST_7
    4'b 1111, // index[28] DMA_SHA2_DIGEST_8
    4'b 1111, // index[29] DMA_SHA2_DIGEST_9
    4'b 1111, // index[30] DMA_SHA2_DIGEST_10
    4'b 1111, // index[31] DMA_SHA2_DIGEST_11
    4'b 1111, // index[32] DMA_SHA2_DIGEST_12
    4'b 1111, // index[33] DMA_SHA2_DIGEST_13
    4'b 1111, // index[34] DMA_SHA2_DIGEST_14
    4'b 1111, // index[35] DMA_SHA2_DIGEST_15
    4'b 0011, // index[36] DMA_HANDSHAKE_INTR_ENABLE
    4'b 0011, // index[37] DMA_CLEAR_INTR_SRC
    4'b 0011, // index[38] DMA_CLEAR_INTR_BUS
    4'b 1111, // index[39] DMA_INTR_SRC_ADDR_0
    4'b 1111, // index[40] DMA_INTR_SRC_ADDR_1
    4'b 1111, // index[41] DMA_INTR_SRC_ADDR_2
    4'b 1111, // index[42] DMA_INTR_SRC_ADDR_3
    4'b 1111, // index[43] DMA_INTR_SRC_ADDR_4
    4'b 1111, // index[44] DMA_INTR_SRC_ADDR_5
    4'b 1111, // index[45] DMA_INTR_SRC_ADDR_6
    4'b 1111, // index[46] DMA_INTR_SRC_ADDR_7
    4'b 1111, // index[47] DMA_INTR_SRC_ADDR_8
    4'b 1111, // index[48] DMA_INTR_SRC_ADDR_9
    4'b 1111, // index[49] DMA_INTR_SRC_ADDR_10
    4'b 1111, // index[50] DMA_INTR_SRC_WR_VAL_0
    4'b 1111, // index[51] DMA_INTR_SRC_WR_VAL_1
    4'b 1111, // index[52] DMA_INTR_SRC_WR_VAL_2
    4'b 1111, // index[53] DMA_INTR_SRC_WR_VAL_3
    4'b 1111, // index[54] DMA_INTR_SRC_WR_VAL_4
    4'b 1111, // index[55] DMA_INTR_SRC_WR_VAL_5
    4'b 1111, // index[56] DMA_INTR_SRC_WR_VAL_6
    4'b 1111, // index[57] DMA_INTR_SRC_WR_VAL_7
    4'b 1111, // index[58] DMA_INTR_SRC_WR_VAL_8
    4'b 1111, // index[59] DMA_INTR_SRC_WR_VAL_9
    4'b 1111  // index[60] DMA_INTR_SRC_WR_VAL_10
  };
